...
from .models import User,Work_Detail,Personal_Detail,Bank_Detail,Experience_Detail,Contact_Detail,Patent,PHD_Awarded,Paper_Publication,Awards,Books,Books_Conference,CSV_Download
